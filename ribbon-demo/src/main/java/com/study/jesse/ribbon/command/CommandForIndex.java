package com.study.jesse.ribbon.command;
...
//                       .withMaxQueueSize(2)
    ...
    protected Object run() throws Exception {
        ...
        Object result = restTemplate.getForObject("http://helloclient/user?id="+id+"",Object.class);
    ...
    protected Object getFallback(){
        System.out.println("降级了"+Thread.currentThread().toString());
        return "出错了，我降级了";
        //降级的处理：
        //1.返回一个固定的值
        //2.去查询缓存
